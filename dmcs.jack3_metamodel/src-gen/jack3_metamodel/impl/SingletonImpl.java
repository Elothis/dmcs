 ...
 * </p>
 * <ul>
 *   <li>{@link jack3_metamodel.impl.SingletonImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SingletonImpl extends MinimalEObjectImpl.Container implements Singleton {
	...
	protected EClass eStaticClass() {
		return Jack3_metamodelPackage.Literals.SINGLETON;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jack3_metamodelPackage.SINGLETON__NAME, oldName,
					name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Jack3_metamodelPackage.SINGLETON__NAME:
			return getName();
		}
